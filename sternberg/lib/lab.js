    ...
    var t = {
            ...
            a = (function () {
              var t = null,
                e = function (e, n) {
                  ...
                  var i = n
                  for (var a in ((n = { get: null, set: null, apply: null, construct: null }), i)) {
                    if (!(a in n))
                  ...
                  var s = this,
                    u = !1,
                    c = "function" == typeof e
                  ;(n.apply || n.construct || c) &&
                    ((s = function () {
                      var t = this && this.constructor === s
                      if ((r(t ? "construct" : "apply"), t && n.construct))
                        return n.construct.call(this, e, arguments)
              ...
              return (
                (e.revocable = function (n, r) {
                  return { proxy: new e(n, r), revoke: t }
                }),
                e
              )
            })()
        ...
        13331: (t, e, n) => {
          ...
          var r = n(17854),
            ...
            z = function (t, e, n, r, o, i) {
              ...
              for (var u = x(s.buffer).bytes, c = a + s.byteOffset, l = r(+o), f = 0; f < e; f++)
                u[c + f] = l[i ? f : e - f - 1]
            }
          if (i) {
            if (
            ...
            (k = function (t) {
              ...
              (P = function (t, e, n) {
                ...
                O(this, { buffer: t, byteLength: n, byteOffset: i }),
                  o || ((this.buffer = t), (this.byteLength = n), (this.byteOffset = i))
              }),
              o && (q(k, "byteLength"), q(P, "buffer"), q(P, "byteLength"), q(P, "byteOffset")),
              s(P.prototype, {
                getInt8: function (t) {
          ...
          t.exports = function (t) {
            ...
            if (
              ...
              for (p = (f = b.call(d)).next, n = new v(); !(l = p.call(f)).done; w++)
                (h = m ? i(f, g, [l.value, w], !0) : l.value), u(n, w, h)
            return (n.length = w), n
          }
        },
        41318: (t, e, n) => {
          ...
          t.exports = f
            ? function (t) {
                ...
                var e = r(this),
                  ...
                  a = n - 1
                for (
                  arguments.length > 1 && (a = s(a, o(arguments[1]))), a < 0 && (a = n + a);
                  a >= 0;
                  a--
                )
            ...
            if (
              ...
              E ||
                (((w = e(function (e, n) {
                  c(e, w, t)
                  var r = d(new m(), e, w)
                  return null != n && u(n, r[g], { that: r, AS_ENTRIES: v }), r
                })).prototype = b),
                (b.constructor = w)),
        ...
        70654: (t, e, n) => {
          ...
          t.exports = function (t, e, n, l, h, x, O) {
            ...
            if (
              ...
              else r({ target: e, proto: !0, forced: v || P }, j)
            return j
          }
        },
        97235: (t, e, n) => {
            ...
            pack: function (t, a, s) {
              ...
              for (
                (t = e(t)) != t || t === 1 / 0
                  ...
                  : ((u = r(o(t) / i)),
                    t * (l = n(2, -u)) < 1 && (u--, (l *= 2)),
                    (t += u + d >= 1 ? v / l : v * n(2, 1 - d)) * l >= 2 && (u++, (l /= 2)),
                    u + d >= h
                      ? ((c = 0), (u = h))
                      : u + d >= 1
                      ? ((c = (t * l - 1) * n(2, a)), (u += d))
                      : ((c = t * n(2, d - 1) * n(2, a)), (u = 0)));
                a >= 8;
                f[g++] = 255 & c, c /= 256, a -= 8
              );
        ...
        13383: (t, e, n) => {
          ...
          var r,
            ...
            h = !1
          ;[].keys &&
            ("next" in (i = [].keys()) ? (o = s(s(i))) !== Object.prototype && (r = o) : (h = !0))
          var d =
            null == r ||
            a(function () {
              var t = {}
        ...
        31320: (t, e, n) => {
          ...
          ;(t.exports = function (t, e, n, s) {
            ...
            "function" == typeof n &&
              ...
              t !== r
                ? (c ? !h && t[e] && (p = !0) : delete t[e], p ? (t[e] = n) : o(t, e, n))
                : p
                ? (t[e] = n)
                : a(e, n)
        ...
        20261: (t, e, n) => {
          ...
          ;(d && v) ||
            ...
            p
              ...
              : g && !f
              ? ((i = (o = new g()).port2), (o.port1.onmessage = j), (r = u(i.postMessage, i, 1)))
              : a.addEventListener &&
                ...
                "file:" !== h.protocol &&
                !s(A)
              ? ((r = A), a.addEventListener("message", j, !1))
              : (r =
                  x in l("script")
                    ? function (t) {
          ...
          i
            ? (L ||
              ...
              r(
                ...
                { getOwnPropertyDescriptor: J, defineProperty: X }
              ),
              (t.exports = function (t, e, n) {
                var i = t.match(/\d+$/)[0] / 8,
                  s = t + (n ? "Clamped" : "") + "Array",
                ...
                L
                  ...
                  N && f(g, N, s),
                  (A[s] = y),
                  r({ global: !0, forced: y != v, sham: !L }, A),
                  V in y || f(y, V, i),
                  V in g || f(g, V, i),
                  j(s)
              }))
        ...
        43074: (t, e, n) => {
          var r = n(90260).aTypedArrayConstructor,
            o = n(36707)
          t.exports = function (t, e) {
            for (var n = o(t, t.constructor), i = 0, a = e.length, s = new (r(n))(a); a > i; )
              s[i] = e[i++]
            return s
          }
        },
            ...
            { target: "Array", proto: !0, forced: !f },
            {
              slice: function (t, e) {
                ...
                if (
                  ...
                  return h.call(f, y, g)
                for (r = new (void 0 === n ? Array : n)(d(g - y, 0)), l = 0; y < g; y++, l++)
                  y in f && c(r, l, f[y])
                return (r.length = l), r
              },
            }
        ...
        16716: (t, e, n) => {
          var r = n(82109),
            o = n(13331)
          r({ global: !0, forced: !n(24019) }, { DataView: o.DataView })
        },
        3843: (t, e, n) => {
          n(82109)(
            { target: "Date", stat: !0 },
        ...
        38862: (t, e, n) => {
          var r = n(82109),
            ...
            l = function (t, e, n) {
              var r = n.charAt(e - 1),
                o = n.charAt(e + 1)
              return (u.test(t) && !c.test(o)) || (c.test(t) && !u.test(r))
        ...
        33321: (t, e, n) => {
          var r = n(82109),
            o = n(19781)
          r({ target: "Object", stat: !0, forced: !o, sham: !o }, { defineProperties: n(36048) })
        },
        69070: (t, e, n) => {
          var r = n(82109),
            o = n(19781)
            ...
            for (
              var S = function (t, e) {
                  ...
                  x
                    ...
                    O && (n = !!e && e.indexOf("y") > -1) && (e = e.replace(/y/g, ""))
                  var s = a(x ? new g(t, e) : g(t, e), r ? this : m, S)
                  return O && n && d(s, { sticky: n }), s
                },
                j = function (t) {
                  ;(t in S) ||
                    s(S, t, {
        ...
        76373: (t, e, n) => {
          ...
          var r = n(82109),
            ...
            P = o(
              function (t, e, n, r) {
                O(this, { type: x, regexp: t, string: e, global: n, unicode: r, done: !1 })
              },
              w,
              function () {
                var t = S(this)
                ...
                return null === r
                  ...
                  : t.global
                  ? ("" == String(r[0]) && (e.lastIndex = y(n, a(e.lastIndex), t.unicode)),
                    { value: r, done: !1 })
            ...
            { target: "String", proto: !0, forced: k },
            {
              matchAll: function (t) {
                ...
                if (null != t) {
                  ...
                  if ((void 0 === (n = t[b]) && m && "RegExp" == c(t) && (n = T), null != n))
                    return s(n).call(t, o)
            ...
            { target: "String", proto: !0 },
            {
              replaceAll: function (t, e) {
                var n,
                  ...
                  O = ""
                if (null != t) {
                  if ((n = i(t)) && !~String(o("flags" in f ? t.flags : a.call(t))).indexOf("g"))
                ...
                (r =
                  ...
                  "".split(/.?/).length
                    ? function (t, n) {
                        ...
                        return (
                          d === r.length ? (!c && y.test("")) || l.push("") : l.push(r.slice(d)),
        ...
        82526: (t, e, n) => {
          ...
          var r = n(82109),
            ...
            it = function (t, e) {
              ...
              return z(n, { type: q, tag: t, description: e }), s || (n.description = e), n
            },
            at = c
              ? function (t) {
            ...
            st = function (t, e, n) {
              ...
              return (
                ...
                f(K, r)
                  ? (n.enumerable
                      ? (f(t, U) && t[U][r] && (t[U][r] = !1), (n = b(n, { enumerable: m(0, !1) })))
                      : (f(t, U) || Y(t, U, m(1, {})), (t[U][r] = !0)),
                    ot(t, r, n))
                  : Y(t, r, n)
              )
            },
          ...
          ;(u ||
            (P(
              (W = function () {
                ...
                return s && rt && ot($, e, { configurable: !0, set: n }), it(e, t)
              }).prototype,
              "toString",
              function () {
                return V(this).tag
          ...
          var r = n(82109),
            ...
            V = function () {
              ...
              var t,
                ...
                h = []
              if (
                (k(l, { type: A, entries: h, updateURL: function () {}, updateSearchParams: q }),
                void 0 !== c)
              )
                if (y(c))
          ...
          s(
            $,
            {
              ...
              set: function (t, e) {
                B(arguments.length, 1)
                for (
                  var n, r = P(this), o = r.entries, i = !1, a = t + "", s = e + "", u = 0;
                  u < o.length;
                  u++
                )
        ...
        85990: (t, e, n) => {
          ...
          ;(P[A] =
            ...
            (t.exports = function t(e, n, T, R, _, M) {
              var I,
                C = 1 & n,
                D = 2 & n,
                F = 4 & n
        ...
        20731: (t, e, n) => {
          ...
          t.exports = function (t, e, n, c) {
            ...
            if (!h) return d
            n && (e = a(e, s(n))),
              c ? ((f = i), (p = !1)) : e.length >= 200 && ((f = u), (p = !1), (e = new r(e)))
            t: for (; ++l < h; ) {
              var y = t[l],
                g = null == n ? y : n(y)
        ...
        47556: (t, e, n) => {
          ...
          t.exports = function (t, e, n) {
            for (
              ...
              h && e && (g = a(g, s(e))),
                (v = c(g.length, v)),
                (d[h] = !n && (e || (f >= 120 && g.length >= 120)) ? new r(h && g) : void 0)
            }
            g = t[0]
            var m = -1,
              b = d[0]
        ...
        40098: (t) => {
          ...
          t.exports = function (t, r, o, i) {
            for (var a = -1, s = n(e((r - t) / (o || 1)), 0), u = Array(s); s--; )
              (u[i ? s : ++a] = t), (t += o)
            return u
          }
        },
        ...
        85022: (t, e, n) => {
          ...
          t.exports = function (t, e, n) {
            for (
              var o = -1, i = t.criteria, a = e.criteria, s = i.length, u = n.length;
              ++o < s;
    ...
    return (
      (() => {
        ...
        var C = (function () {
          function t() {
            ...
            M(this, t),
              (this.internals = {
                callbacks: {},
                rawOptions: R({ debug: !1, plugins: [] }, n),
                parsedOptions: {},
              }),
            ...
            (function (t, e, n) {
              ...
              },
              {
                ...
                value: async function (t) {
                  for (
                    var e, n = this, r = arguments.length, o = new Array(r > 1 ? r - 1 : 0), i = 1;
                    i < r;
                    i++
                  )
                    o[i - 1] = arguments[i]
                      ...
                      throw (
                        (console.error(
                          "%cError in ".concat(this.internals.rawOptions.title, "%c ") +
                            "during event ".concat(t, "%c: ").concat(e),
                          "font-weight: bold",
                          "font-weight: normal",
              ...
              },
              {
                ...
                value: async function (t) {
                  ...
                  this.internals.rawOptions.debug &&
                    (console.info(
                      "%c"
                        ...
                        .concat(this.type, ") → ") +
                        "Event %c".concat(t, "%c · arguments [").concat(n, "]"),
                      "font-weight: bold",
                      "font-weight: normal",
                      "font-weight: bold",
                      "font-weight: normal; opacity: 0.5"
                  ...
                  var a,
                    s = "on".concat(t.replace(o, i)),
                    u = this[s]
                  return (
                    j()(u) && (a = await u.apply(this, n)),
                    await this.trigger.apply(this, [t].concat(n)),
                    this.internals.rawOptions.debug &&
                      console.timeEnd(
                        "".concat(t, " on ").concat(this.internals.rawOptions.title) +
                          "(".concat(this.internals.rawOptions.id, ")")
        ...
        var nt = ["id", "participant", "participant_id"],
          ...
          at = function () {
            ...
            return (
              ...
              "".concat(it((t.getMonth() + 1).toString()), "-") +
              "".concat(it(t.getDate().toString()), "--") +
          ...
          ut = (function (t) {
            ...
            function n() {
              ...
              Y(this, n),
                ...
                et(Z(t), "_debouncedTransmit", B(t.transmit, 2500)),
                et(Z(t), "_lastIncrementalTransmission", 0),
                "session" === r.persistence
                  ? (t.storage = sessionStorage)
                  : "local" === r.persistence
                  ? (t.storage = localStorage)
                  : (t.storage = null),
                r.clearPersistence && t.clear()
              var o = !0
              if (t.storage) {
                ...
                if (i)
                  try {
                    ;(t.data = JSON.parse(i)),
                      (t.state = Object.assign.apply(Object, [{}].concat(W(t.data)))),
              ...
              (function (t, e, n) {
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    t && n.push(Object.keys(this.state)),
                      (n = g()(n)),
                      n.sort(),
                      (n = f()(n, !0).sort())
                    var r = h()(e, n),
                ...
                },
                {
                  ...
                  value: function (t, e, n) {
                    return this._debouncedTransmit(t, e, V({ incremental: !0 }, n))
                  },
                },
                {
        ...
        var At = { frameInterval: 16.68 },
                  ...
                  value: function () {
                    ...
                    this._running
                      ...
                      : ((this._timeoutHandle = (t = window).setTimeout.apply(
                          t,
                          [this.f, this.delay].concat(wt(this.params))
                        )),
                        (this._running = !0))
                  },
                },
          ...
          Rt = { overshoot: 1, closest: 1.5, undershoot: 2 },
          _t = (function () {
            function t(e, n) {
        ...
        var Jt = async function (t, e, n) {
          ...
          Kt = (function () {
            function t(e) {
              ...
              Bt(this, t),
                $t(this, "defaultPayload", { panningModel: "equalpower" }),
                (this.timeline = e),
                (this.options = r),
                (this.payload = qt(
                  qt(qt({}, this.defaultPayload), o),
                  {},
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    if (this.payload.pan && 0 !== this.payload.pan) {
                      ...
                      ;(n.panningModel = this.payload.panningModel),
                        n.setPosition(this.payload.pan, 0, 1 - Math.abs(this.payload.pan)),
                        this.processingChain.push(n)
                    }
                    !(function (t, e, n) {
              ...
              Vt(n, [
                {
                  ...
                  value: async function () {
                    ...
                    ;(this.source = Xt("bufferSource", r, { buffer: s, loop: a })),
          ...
          le = (function () {
            function t(e) {
              !(function (t, e) {
                ...
                (this.processEvent = e.processEvent || ce),
                (this.startTime = -1 / 0)
            }
            return (
              (function (t, e, n) {
            ...
            return function (n) {
              return (
                (function (t) {
                  ...
                  for (var n = 1, r = 1, o = 0; o < t.length - 1; o++)
                    e(t[o], t[o + 1]) ? ++r > n && (n = r) : (r = 1)
                  return n
                })(n, e) <= t
              )
            }
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (j()(o)) e = o
                      ...
                      var u = []
                      o.maxRepSeries && u.push(Oe(o.maxRepSeries, i.equality)),
                        o.minRepDistance && u.push(Se(o.minRepDistance, i.hash)),
                        (e = function (t) {
          ...
          He = function t(e, n, r) {
            ...
            if (!qe()(e))
              return Ne()(e)
                    ...
                    Object.entries(e).map(function (e) {
                      ...
                      return [
                        ...
                        t(
                          c,
                          n,
                          (null === (i = r.content) || void 0 === i ? void 0 : i[u]) ||
                            (null === (a = r.content) || void 0 === a ? void 0 : a["*"]),
                          o
                        ),
                      ]
                    })
                ...
                : e
            var i = Ce()(e, { escape: "", evaluate: "" }).call(o, n)
            switch (r.type) {
              case void 0:
                return i
              case "number":
              ...
              if (document.readyState === t) e()
                ...
                document.addEventListener("readystatechange", function n(r) {
                  r.target.readyState === t &&
                    (r.target.removeEventListener("readystatechange", n), e())
                })
              }
            })
          }
        ...
        var sn = (function () {
            function t(e) {
              nn(this, t),
                an(this, "cache", new Map()),
                an(this, "pending", new Map()),
                (this.cachedFunc = e)
            }
            return (
              on(t, [
        ...
        var _n = Object.freeze({ initialized: 0, prepared: 1, running: 2, done: 3 }),
          Mn = ["debug", "el"],
          In = (function () {
            function t() {
              Pn(this, t),
                (this.datastore = new ut()),
                (this.audioContext = new (window.AudioContext || window.webkitAudioContext)()),
                (this.cache = { images: new cn(), audio: new ln(this.audioContext) }),
                (this.domConnection = new le({ el: document, context: this })),
          ...
          Component = (function (t) {
            ...
            function Component() {
              ...
              return (
                  ...
                  An(
                    (t = n.call(
                      ...
                      wn(
                        ...
                        {},
                        {
                          media: wn({ images: [], audio: [] }, e.media),
                          files: wn({}, e.files),
                          timing: wn({ method: "frames" }, e.timing),
                        }
                      )
                    ))
                  ),
                ...
                kn(An(t), "data", {}),
                kn(An(t), "internals", wn({ timestamps: {} }, t.internals)),
                kn(
                  An(t),
                  "parameters",
                  new window.Proxy(
                    ...
                    {},
                    {
                      ...
                      getOwnPropertyDescriptor: function (e, n) {
                        if (t.options.datastore)
                          return Reflect.getOwnPropertyDescriptor(t.options.datastore.state, n)
                        throw new Error("No datastore to read state from")
                      },
                    }
                  )
                ...
                (t.internals.domConnection = new le({ el: t.options.el, context: An(t) })),
                t.on("run", function () {
              ...
              Rn(Component, [
                    ...
                    if (!this.options.tardy || e) {
                      this.parent &&
                        ...
                        this.parent && this.parent.internals.controller
                          ...
                          : ((this.internals.controller = new In()),
                            this.once("after:prepare", Ye)),
                        (this.options.datastore = this.internals.controller.datastore),
                        (this.internals.timeline = new ne(this.internals.controller)),
                        this.options.debug &&
                      ...
                      if (
                        ...
                        Object.keys(this.options.responses).forEach(function (e) {
                          t.options.events[e] = function (n) {
                            n.preventDefault(),
                              t.respond(t.options.responses[e], {
                        ...
                        ;(this.internals.timeout = new o(function (e) {
                          ...
                          this.on("show", function (e) {
                            t.internals.timeout.run(e),
                              t.options.debug &&
                                (t.internals.timestamps.timeoutTarget =
                                  t.internals.timeout.targetTime)
                          })
                      }
                      ;(this.data = wn(wn({}, this.data), this.options.data)),
                        await this.triggerMethod("prepare", e),
                        (this.status = _n.prepared),
                        await this.preload(),
                ...
                },
                {
                  ...
                  value: async function (t, e) {
                    var n = this,
                      r = async function (t) {
                        ;(n.internals.timestamps.render = t),
                          await n.triggerMethod("render", t),
                          n.internals.timeline.start(t + At.frameInterval),
                          (n.internals.showFrameRequest = window.requestAnimationFrame(function (
                            t
                          ) {
                ...
                },
                {
                  ...
                  value: async function () {
                    var t = this,
                      ...
                      n =
                        arguments.length > 1 && void 0 !== arguments[1]
                          ...
                          : performance.now(),
                      r = arguments.length > 2 && void 0 !== arguments[2] && arguments[2]
                    ;(this.internals.timestamps.end = n),
                      ...
                      ("response" === this.data.ended_on && "Safari" === mt)
                        ? (this.data.duration =
                      ...
                      await this.triggerMethod("end", n, r),
                      this.internals.timeline.end(n + At.frameInterval),
                      !1 !== this.options.datacommit &&
                        this.commit(
                          wn(
                            wn(wn({}, this.aggregateParameters), this.data),
                            {},
                            {
                    ...
                    var o = function (e) {
                      ;(t.internals.timestamps.switch = e),
                        t.options.datastore.update(t.internals.logIndex, function (t) {
                          return wn(
                            wn({}, t),
                            {},
                            {
                  ...
                  value: function () {
                    var t = this,
                      ...
                      o = wn(
                        wn(
                          {},
                          e()(this.internals.rawOptions, function (e, n, o) {
                ...
                },
                {
                  ...
                  get: function () {
                    return []
                      .concat(gn(this.constructor.metadata.module), [this.constructor.name])
                      .join(".")
                  },
                },
              ]),
        ...
        var Dummy = (function (t) {
            ...
            function Dummy() {
              var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
              return Pn(this, Dummy), e.call(this, wn({ skip: !0 }, t))
            }
            return Dummy
          })(Component),
          Cn = (n(68304), n(78659)),
        ...
        var Kn = function (t, e) {
            return (
              ...
              t.forEach(function (t, n) {
                null == e.options.id
                  ? (t.options.id = String(n))
                  : (t.options.id = [e.options.id, n].join("_"))
              }),
              Promise.all(
                t.map(function (t) {
                  return t.prepare(!1)
          ...
          Sequence = (function (t) {
            ...
            function Sequence() {
              ...
              return (
                ...
                ((t = e.call(
                  this,
                  Bn({ content: [], shuffle: !1, indexParameter: void 0 }, n)
                  ...
                  value: async function () {
                    ...
                    this.options.shuffle &&
                      ...
                      this.options.indexParameter &&
                        this.options.content.forEach(function (e, n) {
                ...
                },
                {
                  ...
                  value: function () {
                    this.internals.currentComponent &&
                      this.internals.currentComponent.status !== _n.done &&
                ...
                },
                {
                  ...
                  value: async function (t, e) {
                    ...
                    return (
                      ...
                      this.internals.currentComponent.run(t, e)
                    )
                  },
                },
                {
        ...
        var Parallel = (function (t) {
          ...
          function Parallel() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
            return Vn(this, Parallel), e.call(this, Bn({ content: [], mode: "race" }, t))
          }
          return (
            Wn(Parallel, [
              {
        ...
        const er = (function () {
          function t() {
            for (var e = this, n = arguments.length, r = Array(n), o = 0; o < n; o++)
              r[o] = arguments[o]
            return (
              tr(this, t),
              (this.tag = function (t) {
        ...
        var nr = { separator: "", conjunction: "", serial: !1 }
        const rr = function () {
        ...
        new er(rr({ separator: "," }), ir, ar)
        new er(rr({ separator: ",", conjunction: "and" }), ir, ar)
        new er(rr({ separator: ",", conjunction: "or" }), ir, ar)
        const sr = function (t) {
          return {
            onSubstitution: function (e, n) {
        ...
        new er(fr(/(?:\n(?:\s*))+/g, " "), ar)
        new er(fr(/(?:\n\s*)/g, ""), ar)
        new er(rr({ separator: "," }), fr(/(?:\s+)/g, " "), ar)
        new er(rr({ separator: ",", conjunction: "or" }), fr(/(?:\s+)/g, " "), ar)
        new er(rr({ separator: ",", conjunction: "and" }), fr(/(?:\s+)/g, " "), ar)
        new er(rr, ir, ar)
        new er(rr, fr(/(?:\s+)/g, " "), ar)
        ...
        var Screen = (function (t) {
          ...
          var e = Xr(Screen)
          function Screen(t) {
            return Wr(this, Screen), e.call(this, Vr({ content: null, contentUrl: null }, t))
          }
          return (
            Gr(Screen, [
              {
        ...
        var Frame = (function (t) {
          ...
          function Frame() {
            ...
            return (
              Wr(this, Frame),
              e.call(this, Vr({ content: null, context: "", contextSelector: "" }, t))
            )
          }
          return (
            Gr(Frame, [
              ...
              },
              {
                key: "onEnd",
                value: function () {
                  return this.options.content.status < _n.done
        ...
        var uo = function (t, e) {
          ...
          co = function (t, e, n) {
            var r = uo(t, e, n),
              ...
              a = r.scale,
              s = r.viewportScale,
              u = !0 === n.fromOffset ? { left: 0, top: 0 } : n.canvasClientRect
                    ...
                    "i-text" !== e.type && "text" !== e.type
                      ...
                      : e.text.split("\n").forEach(function (n, r, o) {
                          t.fillText(
                            n,
                            0,
                            (r - 0.5 * (o.length - 1)) * (e.fontSize || 32) * (e.lineHeight || 1.16)
                          )
                        })),
                    e.stroke &&
                      e.strokeWidth &&
        ...
        var Mo = function (t) {
          ...
          Co = function () {
            ...
            if (this.options.insertCanvasOnRun) {
              ...
              ;(this.options.canvas.width = o * n),
                (this.options.canvas.height = i * n),
          ...
          Do = (function (t) {
            ...
            function Screen() {
              ...
              return (
                ...
                ((t = e.call(
                  this,
                  Ro({ content: null, renderFunction: null, clearCanvas: !0 }, Mo(n))
                )).internals.frameRequest = null),
                (t.render = t.render.bind(ko(t))),
                t
              )
            }
            return (
                  ...
                  value: function () {
                    ...
                    ;(this.options.content || [])
                          ...
                          if (["mouseenter", "mouseleave"].includes(r)) {
                            var s = function () {
                              var t =
                                ...
                                n = t
                              return function (t, r) {
                                var o = r.options.ctx.isPointInPath(
                                    r.internals.paths[i.slice(1)],
                                    t.offsetX * a,
                                    t.offsetY * a
                                  ),
                                  s = e ? !n && o : n && !o
                      ...
                      null === this.options.renderFunction &&
                        (this.options.renderFunction = fo(
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    Co.apply(this),
                      ...
                      (this.internals.transformationMatrix = (function (t, e, n) {
                        var r = uo(t, e, n),
                          o = r.translateX,
                          i = r.translateY,
                          a = r.scale
                      ...
                      (t = this.options.ctx).setTransform.apply(
                        t,
                        yo(this.internals.transformationMatrix)
                      )
                  },
                },
                {
                    ...
                    !dn(
                      ...
                      function (e, n) {
                        return (
                          ...
                          (n === t ||
                            n instanceof Do ||
                            n instanceof Sequence ||
                            n instanceof Loop ||
                            n instanceof Parallel)
                        )
                      },
                      !0
                    )
              ...
              },
              {
                ...
                value: async function (t, e) {
                  ...
                  ;(this.options.el.innerHTML = ""),
                    ...
                    Co.apply(this, [!1, this.options.canvas.parentElement]),
                    await this.options.content.run(t, e)
                },
              },
              {
              ...
              (function (t, e, n) {
              ...
              })(Download, [
                {
                  ...
                  value: function (t, e) {
                    ...
                    "end" === e &&
                      t.options.datastore &&
                      (window.addEventListener("beforeunload", Ko),
                      ...
                      this.el.addEventListener("click", function () {
                        t.options.datastore.download(
                          ...
                          window.removeEventListener("beforeunload", Ko)
                      }),
            ...
            })(t, [
              {
                ...
                value: async function (t, e) {
                  if ("before:run" !== e || document.fullscreenElement)
                    "end" === e && this.options.close && lab.util.fullscreen.exit()
                  else {
        ...
        var yi = "20.2.4",
          gi = { flavor: "production", commit: "f5b4a49f956347addd546a832a3327688c2c0fef" },
          mi = { Component, Dummy },
          bi = { Frame: Fo, Screen: Do },
          wi = { Screen, Form, Frame, Page },
          xi = { Sequence, Parallel, Loop },
          Oi = {
            Debug,
            Download,
            Fullscreen: ti,
                ...
                })(Metadata, [
                  {
                    ...
                    value: function (t, e) {
                      if ("prepare" === e) {
                        ...
                        t.options.datastore.set({ url: n, meta: ii() })
                      }
                    },
                  },
                ]),
              ...
              return (
                (function (t, e, n) {
                ...
                })(t, [
                  {
                    ...
                    value: function (t, e) {
                      "prepare" === e
                        ? window.addEventListener("beforeunload", si)
                        : "end" === e && window.removeEventListener("beforeunload", si)
                    },
                  },
                ]),
                t
                      ...
                      if ("after:end" === e && t.options.datastore) {
                        ...
                        try {
                          ...
                          r.items.add(new File([t.options.datastore.exportCsv()], "data.csv")),
                            (n.elements.dataFile.files = r.files)
                        } catch (e) {
                          console.log(
                            "Couldn't append data file to form falling back to direkt insertion. Error was",
                            e
                          ),
                            (n.elements.dataRaw.value = t.options.datastore.exportCsv())
                        }
                        n.submit()
                      }
                    },
            ...
            Transmit: (function () {
              function Transmit() {
                ...
                di(this, Transmit),
                  ...
                  (this.metadata.id = this.metadata.id || Pe()),
                  (this.updates = {
                    ...
                    value: function (t, e) {
                      ...
                      switch (e) {
                        ...
                        case "epilogue":
                          this.updates.full &&
                            t.options.datastore
                              .transmit(r, pi(pi({}, o), {}, { payload: "full" }), {
                                headers: this.headers,
                                encoding: this.encoding,
                              })
                              .then(function (e) {
                                return (
                                  n.updates.incremental &&
          ...
          ji = {
            Random,
            fromObject: Bo,
            canvas: { makeRenderFunction: fo, transform: lo },
            combinatorics: {
              product: function* () {
            ...
            timing: { FrameTimeout: _t },
            tree: { traverse: hn, reduce: dn },
          }
      })(),
      r
    )
